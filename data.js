...

{
  ...
  checklist:['Research one specific, real detail about the company','Draft your base letter with your strongest single story','Cut any sentence that just repeats your resume','Address a specific person or team if you can find one','Keep it under 300 words','Proofread out loud before sending'],
  ...
  takeaways:['A cover letter explains motivation and fit — it should never just repeat your resume.','One strong personal story beats five generic claims.','Reuse a base letter, but personalize the opening and closing for each role.','Under 300 words is a good target — focus beats length.'],
...

{
  ...
  checklist:['Write one rough 1-year and one 3-year professional goal','Schedule a recurring monthly or quarterly feedback check-in','Start a "wins" document and add to it monthly','Identify one skill you want to build in the next 6 months','Ask a mentor or manager what growth could look like in this role','Have a direct conversation about growth rather than assuming it\'ll happen'],
  ...
  takeaways:['A career is a job shaped by intention over time — you don\'t need a rigid plan, just a direction.','Regular feedback prevents unpleasant surprises at review time.','Track your own wins; don\'t rely on memory alone.','Growth rarely happens automatically — it usually requires asking for it directly.'],
...

{
  ...
  practiceExercises:[
    {title:'Bank comparison worksheet', body:'Pick two banks or credit unions (at least one should be a credit union or online-only bank). Using the comparison table above, fill in each of the six factors side by side. Circle which one wins on each row, then decide which account you\'d actually open and why.'},
    {title:'Fee-waiver script', body:'Write a two-sentence script you could say to a bank representative to ask about waiving the monthly maintenance fee (e.g., student status, setting up direct deposit). Practice saying it out loud once — asking gets easier with rehearsal.'},
  ],
  ...
  reflection:['Have you ever been surprised by a bank fee — what happened, and how did you find out?','What would make you trust a bank or credit union with your money?','What\'s one savings goal specific enough that naming an account after it would help?'],
  quiz:[
...

{
  ...
  download:'tax-checklist', journeys:['financial'], nextInJourney:'taxes',
},

{
  ...
  practiceExercises:[
    {title:'Document checklist walkthrough', body:'Based on your actual situation this year (job, gig work, both, or neither), list every document you\'d need to gather. If you don\'t have one yet, write down where you\'d go to get it (employer HR, a platform\'s tax section, etc.).'},
    {title:'Deduction/credit spotting', body:'List three things about your life right now (student status, job type, location, dependents) that might make you eligible for a specific deduction or credit. You don\'t need exact answers — just practice noticing what to look for later.'},
  ],
  ...
  reflection:['What part of taxes has felt most confusing or intimidating to you?','Do you know where to find your income documents when the time comes?','Who could you ask for help if you got stuck partway through?'],
  quiz:[
...

{
  ...
  practiceExercises:[
    {title:'Find $20 exercise', body:'Look through your last month of spending (bank app, receipts, memory) and find one recurring cost of at least $20/month you could redirect — a subscription, a habit, a category you could trim. Write down exactly what it is and set up the redirect this week.'},
    {title:'Emergency definition test', body:'Write down three things that have felt like "emergencies" to you in the past year. For each, apply the test: was it unplanned, and was it necessary? Sort them into "real emergency" and "should have its own savings goal instead."'},
  ],
  ...
  reflection:['What has felt like a financial emergency for you in the past — and how did you handle it?','What\'s one small, recurring expense you could redirect toward this fund?','What would having even $300 saved change about how you feel day to day?'],
  quiz:[
...

{
  ...
  practiceExercises:[
    {title:'Order-of-operations check-in', body:'Using the 5-step order of operations above, write down honestly which step you\'re currently on. If you\'re not yet at step 4, identify the one action that would move you to the next step.'},
    {title:'Scam-spotting practice', body:'Find (or recall) an investment ad, DM, or social post promising unusually high or guaranteed returns. List the specific red-flag language it uses, using the warning signs described in this playbook.'},
  ],
  ...
  reflection:['What have you heard about investing that turned out to be a myth once you looked closer?','What\'s a small, sustainable amount you could realistically set aside to invest monthly?','What would it mean for your future self if you started now, even small?'],
  quiz:[
...

{
  ...
  practiceExercises:[
    {title:'Three-layer goal-setting', body:'Write one specific, real goal for each timeframe: 1 year, 5 years, and "someday." Make each one concrete enough that you\'d know clearly when you\'d achieved it.'},
    {title:'Raise-and-windfall rule', body:'Write a simple, one-sentence rule for what you\'ll do the next time you get a raise, bonus, or unexpected windfall (e.g., "50% to savings, 50% to spending"). Decide it now, before the money arrives.'},
  ],
  checklist:['Write one goal each for 1 year, 5 years, and "someday"','Review your current debt, savings, and investing balance in one place','Schedule a recurring yearly financial check-in date','Decide in advance what you\'ll do with your next raise or bonus','Revisit your goals whenever a major life change happens'],
  reflection:['What does financial security actually look like to you, specifically?','Is there a goal you\'ve been putting off because it felt too far away to plan for?','How do you want to handle your next raise before it happens, so the decision is already made?'],
  quiz:[
...

{
  ...
  practiceExercises:[
    {title:'One-week time-block trial', body:'Block your upcoming week using rough time windows (not exact minutes) for classes, work, study, rest, and social time. At the end of the week, note which blocks held up and which didn\'t.'},
    {title:'Five-minute first steps', body:'Pick the task you\'ve been avoiding most. Write down the smallest possible first step — something completable in five minutes or less. Do it today.'},
  ],
  ...
  reflection:['What\'s one "important but not urgent" thing you\'ve been putting off?','When do you procrastinate most — what does the task usually have in common?','What would a genuinely sustainable weekly schedule look like for you, rest included?'],
  quiz:[
...

{
  ...
  practiceExercises:[
    {title:'Recall vs. reread test', body:'Pick two similar topics you need to study. Study one using rereading/highlighting as usual, and the other using active recall (close the material, write what you remember, then check). The next day, quiz yourself on both without looking — compare which one you remember better.'},
    {title:'Build your spacing calendar', body:'For one subject, write down today\'s date and schedule three follow-up review dates: 1 day, 3 days, and 1 week later. Set reminders for each.'},
  ],
  ...
  reflection:['What study habit have you relied on that you suspect isn\'t actually working well?','What subject would benefit most from active recall instead of rereading?','What does a sustainable, non-cramming study week look like for you?'],
  quiz:[
...

{
  ...
  practiceExercises:[
    {title:'Three-foundations check-in', body:'Rate your last week from 1–5 on each of the three foundations: sleep, movement, connection. Pick whichever scored lowest and choose one small, realistic step to nudge it up this week.'},
    {title:'Find your resource before you need it', body:'Look up your school\'s (or a local/national) counseling or wellness resource right now, even if you don\'t currently need it. Save the contact information somewhere you\'d actually find it later.'},
  ],
  ...
  reflection:['What does burnout tend to look like for you, specifically?','What\'s one small daily practice that has helped you feel steadier in the past?','Who is someone you trust enough to be honest with about how you\'re really doing?'],
  quiz:[
...

{
  ...
  download:'habit-tracker', journeys:[], nextInJourney:null,
},

{
  ...
  reflection:['What matters most to you in a first place — cost, location, space, or something else?','What would make you feel confident enough to sign a lease, versus still uncertain?','Have you (or has someone you know) ever run into a surprise cost or issue with a rental — what happened?'],
  quiz:[
  ...
  download:'apartment-checklist', journeys:[], nextInJourney:null,
},

{
  ...
  practiceExercises:[
    {title:'Five-organization list', body:'List five organizations you\'d genuinely want to learn from — mix at least two well-known names with at least two smaller or local ones. For each smaller one, write a one-sentence reason you\'re specifically interested.'},
    {title:'Direct outreach draft', body:'Draft a short, three-sentence message you could send to a small organization asking whether they take interns. Include: who you are, why you\'re interested in them specifically, and what you\'d hope to learn.'},
  ],
  ...
  reflection:['What field or role are you genuinely curious about, even if you\'re not sure you\'re "qualified" yet?','What\'s one smaller organization you could reach out to directly?','What would make an internship feel worthwhile to you beyond the resume line?'],
  quiz:[
...

{
  ...
  practiceExercises:[
    {title:'Write your 90-day plan', body:'Using the three-phase timeline above, write your own specific version: what you\'ll do in days 1–30, 31–60, and 61–90. Include at least one honest check-in date.'},
    {title:'Bridge job criteria', body:'Write down two or three criteria that would make a job an acceptable "bridge" for you (e.g., pays enough, doesn\'t consume all your job-search energy, teaches at least one useful skill). Having criteria in advance makes the decision easier if the moment comes.'},
  ],
  ...
  reflection:['What would "enough direction" feel like right now, even without full certainty?','What would you consider a reasonable bridge job while you figure out the bigger picture?','Who in your life makes you feel supported rather than pressured about this transition?'],
  quiz:[
